...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-alabama-dev-key-change-in-production-xyz987abc')
...
# Protected pages send unauthenticated visitors to the CRM login, then back.
LOGIN_URL = '/accounts/login/'
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/accounts/login/'

ROOT_URLCONF = 'alabama_project.urls'
...
WSGI_APPLICATION = 'alabama_project.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'alabama_db'),
...
# Phone Number IDs Alabama owns and handles natively.
# Set these via the WHATSAPP_PHONE_NUMBER_IDS env var (comma-separated).
...
# Populate with Alabama's own number IDs, e.g. {'<phone_number_id>': '+971 ...'}.
