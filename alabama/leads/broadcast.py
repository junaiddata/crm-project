...
# Alabama's default sending Phone Number ID — set via WHATSAPP_DEFAULT_PHONE_ID,
# otherwise the first configured WHATSAPP_PHONE_NUMBER_IDS entry is used.
DEFAULT_PHONE_ID = os.environ.get('WHATSAPP_DEFAULT_PHONE_ID', '')
