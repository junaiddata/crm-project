...
# Where the "Alabama" button points. Served on this same site at /alabama/.
# Override per environment if Alabama ever moves to its own host.
ALABAMA_URL = os.environ.get('ALABAMA_URL', '/alabama/')
